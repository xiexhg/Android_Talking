...
public class ChartManager extends Activity implements View.OnClickListener {
        ...
        public void  handleMessage(Message msg){
            switch (msg.what){
                case RECEIVE_MSG:
                    ...
                    Log.i("talking", "handleMessage msg is at:" + recmsg);
                    Log.i("talking", "in list handleMessage msg is at:" + msgList.get(node));
                    RemoteMessageHandle.messageHandle(recmsg);
                    return;
                case IMAGE_DONE:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new MsgAdapter(ChartManager.this,msgList);
